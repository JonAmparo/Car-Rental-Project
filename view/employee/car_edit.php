                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" id ="EditCar" name="EditCar" action="index.php/?controller=car&action=editCar" method="POST" enctype="multipart/form-data">           
                                        <div class="form-group">
                                            <label>ID</label>
                                            <input type= "text" class="form-control" 
                                            name="ID" id="ID" value="<?=$carForEdit->getCarID()?>" readonly="readonly">
                                        </div>

                                        <div class="form-group">
                                            <label>Brand</label>
                                            <input type= "text" name="brand" id="brand" class="form-control" value="<?=$carForEdit->getBrand()?>">
                                        </div>

                                        <div class="form-group">
                                            <label>Model</label>
                                            <input type= "text" name="model" id="model" class="form-control" value="<?=$carForEdit->getModel()?>" >
                                        </div>
                                        <div class="form-group">
                                            <label>Type</label>
                                            <input type= "text" name="type" id="type" class="form-control" value="<?=$carForEdit->getType()?>">
                                        </div>

                                        <div class="form-group">
                                            <label>Tank Capacity</label>
                                            <input type= "number" name="tankCapacity" id="tankCapacity" class="form-control" value="<?=$carForEdit->getTankCapacity()?>" >
                                        </div>

                                        <div class="form-group">
                                            <label>Gas Consumption</label>
                                            <input type= "number" name="gasConsumption" id="gasConsumption" class="form-control" value="<?=$carForEdit->getGasConsumption()?>" >
                                        </div>
                                        <div class="form-group">
                                            <label>Color</label>
                                            <input type= "text" name="color" id="color" class="form-control" value="<?=$carForEdit->getColor()?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Number of Passenger</label>
                                            <input type= "number" name="numberofPassenger" id="numberofPassenger" class="form-control" value="<?=$carForEdit->getNumberofPassenger()?>">
                                        </div>

                                        <div class="form-group">
                                            <label>Rent Price</label>
                                            <input type= "number" min =0 name="rentPrice" id="rentPrice" class="form-control"  value="<?=$carForEdit->getRentPrice()?>">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="3" name="description" id="description"  value="<?=$carForEdit->getDescription()?>" ></textarea>

                                        </div>

                                        <div class="form-group">
                                            <label>Status</label>
                                            <input type= "number" min =0 max=1 name="status" id="status" class="form-control" value="<?=$carForEdit->getStatus()?>">
                                        </div>
                                        
                                        <button type="submit" name="editCar" class="btn btn-primary">Submit Button</button>
