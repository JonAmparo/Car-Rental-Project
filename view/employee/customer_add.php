...
<head>
    ...
    <title>Employee - Add Customer</title>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action ="../../index.php/?controller=user&action=addCustomer" method="POST" id="form_customer" name="form_customer ">
                                        ...
                                        <button type="submit" name="saveCustomer" class="btn btn-primary">Submit Button</button>
