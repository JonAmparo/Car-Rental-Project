...
<head>
    ...
    <title>Employee - Edit Customer</title>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                     <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <form role="form" action="index.php/?controller=user&action=editCustomer" method="POST" name="form_edit_customer">

                                    <div class="form-group">
                                        <label>ID</label>
                                        <input type="text" name="ID" id="ID" value="<?=$customerEdit->getCustomerID() ?>" class="form-control" readonly="readonly">
                                    </div>

                                    <div class="form-group">
                                        <label>First Name</label>
                                        <input type="text" name="firstname" id="firstname" value="<?=$firstname?>" class="form-control" placeholder="First Name">
                                    </div>

                                    <div class="form-group">
                                        <label>Last Name</label>
                                        <input type="text" name="lastname" id="lastname" value="<?=$lastname ?>" class="form-control" placeholder="Last name">
                                    </div>
                                    <div class="form-group">
                                        <label>Username</label>
                                        <input type="text" name="username" id="username" value="<?=$customerEdit->getUserName() ?>" class="form-control">
                                    </div>


                                    <div class="form-group">
                                        <label>Date of Birth</label>
                                        <input type="date" name="dateofBirth" id="dateofBirth" value="<?=$customerEdit->getDateofBirth() ?>" max="1999-06-18" min="1949-06-18" class="form-control" placeholder="mm/dd/yyyy">
                                    </div>

                                    <div class="form-group">
                                        <label>Phone</label>
                                        <input type="text" name="phone" id="phone" value="<?=$customerEdit->getPhone() ?>" class="form-control" placeholder="###-###-####">
                                    </div>

                                    <div class="form-group">
                                        <label>Email</label>
                                        <input type="email" name="customerEmail" value="<?=$customerEdit->getCustomerEmail() ?>" id="customerEmail" class="form-control" placeholder="email@something.com">
                                    </div>

                                    <div class="form-group">
                                        <label>Address</label>
                                        <input type="text" name="address" id="address" value="<?=$customerEdit->getAddress() ?>" class="form-control" placeholder="123 Something Street">
                                    </div>

                                    <div class="form-group">
                                        <label>Driver Licence</label>
                                        <input type="number" name="customerDriverLicence" value="<?=$customerEdit->getCustomerDriverLicence() ?>" id="customerDriverLicence" class="form-control">
                                    </div>

                                    <div class="form-group">
                                        <label>Credit Card Number</label>
                                        <input type="number" name="creditCard" value="<?=$customerEdit->getCreditCard() ?>" id="creditCard" class="form-control">
                                    </div>

                                    <button type="submit" name="editCustomer" class="btn btn-primary">Submit Button</button>
