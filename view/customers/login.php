...
if(isset($_SESSION['error'] )) { ?>
	...
	<div class="container" >
		...
		<div class="col-sm-6">
			...
			<form action="../../index.php/?controller=user&action=login" class="form-login" method="post"  name="userLogin" id="userLogin">
				...
				<?php if ($user==null || empty($user) ) {?>
					<div class="row">
						...
						<div class="col-md-12">
							<div class="form-group"><input class="form-control" name="username" id="username" type="text" placeholder="User name"></div>
						</div>
						<div class="col-md-12">
						...
						<div class="col-md-6">
							<input type="submit" name="login" id="login"  class="btn btn-theme btn-block btn-theme-dark"  value= "Login" />
						</div>
					</div>
				<?php } 
					...
					{?>
						...
						<div class="row">
							...
							<div class="col-md-6">
								<input type="submit" name="login" id="logout"  class="btn btn-theme btn-block btn-theme-dark"  value= "Login" />
							</div>
			...
			<p class="text-center">
				...
				<a href="../../index.php/?controller=user&action=createAccountCustomerView" name="createCustomerForm" value= "Create Account">
					Sign up here!
				</a>
			</p>
			<p class="text-center">
				...
				$(function () {
					$("#userLogin").submit(function (e) {
						...
						if (password.val().length < 1) {
							...
							password.parent().append("<span class='error'> Your password cannot be empty.</span>");
							$(".error").fadeIn(500);
						} else {
						...
						if (username.val().length < 1 ) {
							...
							username.parent().append("<span class='error'>Your username cannot be empty.</span>");
							$(".error").fadeIn(500);
						} else {
